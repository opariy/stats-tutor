      ...
      <div className="max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-10">
          <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-soft-sm">
            <p className="text-sm text-stone-500 mb-2 font-medium">Total Participants</p>
          ...
          <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-soft-sm">
            <p className="text-sm text-stone-500 mb-2 font-medium">Total Feedback</p>
            <p className="text-4xl font-bold text-stone-900">{stats.feedback.total}</p>
          </div>
          <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-soft-sm">
