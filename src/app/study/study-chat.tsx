  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch("/api/chat", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ messages: newMessages, group, sessionId }),
      });
    ...
    return (
      <div className="flex flex-col h-screen bg-white">
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          ...
          <p className="text-gray-500 text-sm mb-6">Chapters 1-10</p>
    ...
    <div className="flex flex-col h-screen bg-white">
      <div className="border-b border-gray-100 px-4 py-3 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Chapters 1-10</p>
        </div>
      </div>
